...
namespace cell {
	...
	public:
		...
		int getLiveNumber() { return liveNumber; }
		int getDeadNumber() { return deadNumber; }
		int getRange() { return range; }
		int getAgeLimit() { return ageLimit; }
		int getAfterDeadLimit() { return afterDeadLimit; }
		void setAge(int _age) { age = _age; }
		int getAge() { return age; }
		void setAfterDead(int _afterDead) { afterDead = _afterDead; }
		int getAfterDead() { return afterDead; }
