...
static const int CONSUMER_PRODUCE_AGE = 2;
static const int CONSUMER_STARVING_TIME= 1;
//高级消费者参数
...
static const int HIGH_CONSUMER_PRODUCE_AGE = 3;
static const int HIGH_CONSUMER_STARVING_TIME = 2;
class cell
{
public:
